...
const showPlayButton =document.body.querySelector(".play")
const Stop = document.getElementById("Stop");
const hello = document.body.querySelector("h1");
const firstScene= document.body.querySelector(".scene1");
const canvas= document.body.querySelector("canvas");


hello.addEventListener("click", scene1)
...
(function(w) {
    ...
    */
    ...
    var canvas_height = 1200; //This too.
    ...
    function update_particle() {
        ...
        for (i = 0; i < particles.length; i++) {
            ...
            if (p.x >= 0 && p.x < canvas_width && p.y >= 0 && p.y < canvas_height) {
                ...
                */
                p.xv += ax * cell_data.right.xv * 0.1;
                p.yv += ax * cell_data.right.yv * 0.1;
                
                p.xv += ay * cell_data.down.xv * 0.1;
                p.yv += ay * cell_data.down.yv * 0.1;
